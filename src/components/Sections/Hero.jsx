        ...
        <section id="hero" className=" text-center flex items-center justify-center" style={{
            ...
            <main className="container mx-auto px-4 py-20">
                <div className=" text-center p-4 flex flex-col justify-center items-center relative">
                    <h1 className="text-5xl mx-auto font-bold w-full mb-4 text-white md:text-6xl md:w-200">Find Your Strength. Fuel Your Mind. <span className="text-white"> Move with Mortivana.</span></h1>
