            ...
            <div className="container mx-auto text-center">
                <div className="flex justify-between mb-5">
                    <div className="flex items-baseline space-x-3  mx-20">
                        <img src="/logo2.png" alt="business logo" className="h-15 w-auto hidden md:block" />
                        <h1 className="text-xl  font-bold">Mortivana</h1>
                    </div>
                ...
                <p className="mt-8 text-sm">&copy;2025 Motivana - All rights reserved.</p>
