        ...
        >
            <div className="flex items-center justify-end md:justify-center lg:justify-end px-6 py-4">
                    ...
                    {links.map(({ id, name, to }) => (
                        <li key={id}>
                            <button
                                ...
                                className="cursor-pointer text-white transition focus:outline-none  rounded"
                            >
                                {name}
                            </button>
                        </li>
                ...
                <button
                    ...
                    className="md:hidden cursor-pointer text-white text-2xl focus:outline-none focus:ring-2 focus:ring-violet-800 rounded"
                >
                ...
                >
                    {links.map(({ id, name, to }) => (
                        <li key={id}>
                            <button
                                onClick={() => handleScroll(to)}
                                className="cursor-pointer text-white hover:text-violet-900 text-lg focus:outline-none focus:ring-2 focus:ring-violet-800 rounded"
                            >
                                {name}
                            </button>
                        </li>
